...
public class Make24App {
    ...
    // MODIFIES: this
    // EFFECTS: starts new game and prompt user to compute 24. If the user does not reach 24 after a series of
    ...
    // EFFECTS: returns the only number remaining after choosing one from two
    ...
    // EFFECTS: takes user input and identifies its corresponding number. Print message of chosen number and returns it
    ...
    // EFFECTS: Prompts user to choose operation to operate on the two chosen numbers. Return the new number that is
    // computed using the consumed chosen numbers and consumed operation.
    ...
    // EFFECTS: prompts user to choose one of four operations
    ...
    // REQUIRES: user input must be one of 1, 2 or 3
    // EFFECTS: prompts user to choose the second number for the first operation and returns the number chosen.
    ...
    // EFFECTS: print out the remaining 3 numbers that can be chosen after first number has been chosen.
    ...
    // REQUIRES: user input must be one of 1, 2, 3 or 4
    // MODIFIES: this
    // EFFECTS: returns the chosen number and prints a statement to verify it
